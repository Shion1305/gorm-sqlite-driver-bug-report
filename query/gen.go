...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		Something:       newSomething(db, opts...),
	}
}
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		Something:       q.Something.clone(db),
	}
}
